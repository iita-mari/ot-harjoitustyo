...
class TestKassapaate(unittest.TestCase):
    ...
    def test_kateisosto_edulliset_toimii_kun_rahaa_riittavasti(self):
        self.kassa.syo_edullisesti_kateisella(300)

        self.assertEqual(self.kassa.kassassa_rahaa, 100240)
        self.assertEqual(self.kassa.edulliset, 1)

    def test_kateisosto_maukkaat_toimii_kun_rahaa_riittavasti(self):
    ...
    def test_kassassa_rahat_oikein_euroina(self):
